...
set_target_properties(unofficial::brotli::brotlienc-static PROPERTIES
  ...
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "m;unofficial::brotli::brotlicommon-static"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libbrotlienc-static.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS unofficial::brotli::brotlienc-static )
list(APPEND _IMPORT_CHECK_FILES_FOR_unofficial::brotli::brotlienc-static "${_IMPORT_PREFIX}/debug/lib/libbrotlienc-static.a" )
...
set_target_properties(unofficial::brotli::brotlidec-static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "m;unofficial::brotli::brotlicommon-static"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libbrotlidec-static.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS unofficial::brotli::brotlidec-static )
list(APPEND _IMPORT_CHECK_FILES_FOR_unofficial::brotli::brotlidec-static "${_IMPORT_PREFIX}/debug/lib/libbrotlidec-static.a" )
...
set_target_properties(unofficial::brotli::brotlicommon-static PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libbrotlicommon-static.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS unofficial::brotli::brotlicommon-static )
list(APPEND _IMPORT_CHECK_FILES_FOR_unofficial::brotli::brotlicommon-static "${_IMPORT_PREFIX}/debug/lib/libbrotlicommon-static.a" )
